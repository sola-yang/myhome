   ...
   <hr style="height:1px;border:none;border-top:1px solid #555555;" />
    <div style="width: 50%;height:100%;float:left;" >
       <form action="${basePath }/system/register" method="post" class="form-horizontal"  role="form" id="userRegisterForm">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="account" name="userName" maxlength="32"
	   ...
	   <div class="form-group">
		...
		<div class="col-sm-10">
			 <input type="number" class="form-control"   id="phone" name="phoneNum" pattern="^1[3|4|5|8][0-9]\d{4,8}$ "
		...
		<div class="col-sm-10">
			 <input type="number" class="form-control" id="qq" name="qqCount" maxlength="16"
		...
		<div class="col-sm-10">
			 <input type="text" class="form-control" id="wechart" name="weChartCount" maxlength="16"
